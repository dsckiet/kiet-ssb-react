    ...
    <>
      ...
      <div className="fluid-container">
              ...
              <div className="row">
                ...
                <div className="col-lg-9 col-sm-12">
                  <p>
                    ...
                    enabling the individuals to confidently face the SSB
                    Interview successfully. The KIET SSB Academy has excellent
        ...
        <div className="complex mt-5 ">
          <div className="row">
            <div className="col-lg-9 col-md-6 col-sm-8"></div>
            <div
              className="col-lg-3 col-md-6 col-sm-4 card cardBtn text-center"
